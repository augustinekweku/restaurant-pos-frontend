    ...
    <div :class="darkMode ? 'darkMode' : ''" id="main-wrapper">
        ...
        <div class="_navbar_right">
          <ul class="_navbar_right_list">
            ...
            <div class="_navbar_right">
              ...
              <ul class="_navbar_right_list">
                <li class="_mosearch d-none" @click="mobSearchOpen = true">
                  <Icon type="ios-search-outline" />
                </li>
            ...
            <Menu :theme="theme3" :active-name="activeRoute">
              <MenuGroup title="Dashboard">
                ...
                >
                  ...
                  <MenuItem to="/ready-orders" name="ready-orders">
                    <Icon type="md-alarm" style="color: green !important" />
                    <span class="submenu_text">
                      Ready Orders
                      <Tag v-if="readyOrdersCount" color="error">{{
                        readyOrdersCount
                      }}</Tag></span
                    >
                  </MenuItem>
                ...
                >
                  ...
                  <MenuItem to="/orders" name="orders">
                    <Icon type="md-clock" style="color: #2d8a99 !important" />
                    <span class="submenu_text">
                      Orders
                      <Tag v-if="orderNotificationsCount > 0" color="error">{{
                ...
                <Submenu name="credit">
                  <template slot="title">
                    ...
                    <span class="submenu_text" style="color: #7a4a59 !important"
                      >Credit</span
                    >
                  </template>
                  <MenuItem
                  ...
                  >
                    ...
                    <span class="submenu_text fw-light"> Creditor POS</span>
                  </MenuItem>
                  <MenuItem
                    to="/creditor-orders"
                  ...
                  >
                    ...
                    <span class="submenu_text fw-light"
                      >Orders on Credit
                      <Tag
                        v-if="CreditOrderNotificationsCount > 0"
                        color="error"
                        >{{ CreditOrderNotificationsCount }}</Tag
                      >
                    </span>
                  </MenuItem>
                  <MenuItem
                  ...
                  >
                    ...
                    <span class="submenu_text fw-light"
                      >Orders pending payment<Tag
                        class="me-2"
                        v-if="CreditReadyOrdersCount > 0"
                        color="error"
                        >{{ CreditReadyOrdersCount }}</Tag
                      >
                    </span>
                  </MenuItem>
                  <MenuItem
                  ...
                  >
                    <Icon
                      ...
                      style="color: #7a4a59 !important"
                    />
                    <span class="submenu_text fw-light"> Report</span>
                  </MenuItem>
                </Submenu>
          ...
          <div class="_left_sidebar_bottom _1border_color">
            <Menu :theme="theme3" active-name="1">
              <MenuItem name="sunny">
                ...
                <span @click="lightSidebarClick" class="submenu_text"
                  >Light</span
                >
              </MenuItem>
              <MenuItem name="moon">
      ...
      >
        <div class="container-fluid">
          <Welcome v-if="$route.path == '/dashboard'" />
          <Nuxt />
        </div>
        <Footer
          v-if="
